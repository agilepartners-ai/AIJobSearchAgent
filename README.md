...
An AI-powered job search application built with VITE.js, React, and TypeScript that helps users find, apply to, and manage job applications efficiently.
...
- **Minification**: Automatic with VITE.js build
