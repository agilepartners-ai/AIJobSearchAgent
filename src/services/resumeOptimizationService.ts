  ...
  static transformApiResponse(apiResponse: OptimizationResponse): any {
    ...
    if (apiResponse.success && apiResponse.data) {
      ...
      return {
        ...
        // Updated to DOCX-centric placeholder URLs (remove PDF placeholders)
        optimizedResumeUrl: "https://example.com/ai-enhanced-detailed-resume.docx",
        optimizedCoverLetterUrl: "https://example.com/ai-enhanced-detailed-cover-letter.docx",
