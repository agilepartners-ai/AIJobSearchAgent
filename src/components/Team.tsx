...
const TeamMember: React.FC<TeamMemberProps> = ({ image, name, role, linkedin, mail }) => {
  return (
    <div className="bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all group px-4 py-6 sm:p-6 h-[340px] sm:h-[380px] flex flex-col">
      <div className="flex flex-col items-center text-center flex-1">
        <div className="w-32 h-32 sm:w-40 sm:h-40 rounded-full overflow-hidden mb-4 ring-4 ring-gray-700 group-hover:ring-blue-800 transition-all flex-shrink-0">
          <img 
            src={image} 
            alt={name} 
        ...
        <div className="flex-1 flex flex-col justify-between w-full">
          <div>
            <h3 className="text-lg sm:text-xl font-semibold text-white mb-1 min-h-[28px] sm:min-h-[32px]">{name}</h3>
            <p className="text-sm sm:text-base text-blue-400 font-medium mb-3 min-h-[40px] sm:min-h-[48px] flex items-center justify-center">{role}</p>
          </div>
          <div className="flex gap-3 justify-center">
            <a 
              href={linkedin}
              className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-700 text-gray-300 hover:bg-blue-900/30 hover:text-blue-400 transition-colors"
...
const Team: React.FC = () => {
 ...
 useEffect(() => {
  ...
  return (
    <section id="about" className="py-20 bg-gray-900 backdrop-blur-sm">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <span className="text-blue-400 font-medium text-lg">Our Team</span>
        ...
        <div className="relative max-w-7xl mx-auto">
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 sm:-translate-x-8 md:-translate-x-12 lg:-translate-x-16 z-10 w-14 h-14 bg-gray-800 rounded-full shadow-lg flex items-center justify-center text-gray-300 hover:text-blue-400 hover:shadow-xl transition-all group border border-gray-700"
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 sm:-translate-x-8 md:-translate-x-12 lg:-translate-x-16 z-10 w-14 h-14 bg-gray-800 rounded-full shadow-lg flex items-center justify-center text-gray-300 hover:text-blue-400 hover:shadow-xl transition-all group border border-gray-700"
