...
const Hero: React.FC = () => {
  return (
    <div className="relative min-h-screen flex items-center bg-gray-950 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="block lg:hidden w-full h-full bg-gradient-to-br from-gray-950 via-blue-950/50 to-gray-950">
          {/* Enhanced Animated Particles for Mobile */}
          <div className="absolute inset-0 overflow-hidden">
            {[...Array(30)].map((_, i) => (
              <div 
                key={i}
                className="absolute rounded-full bg-blue-400/15 animate-float"
                style={{
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen py-20 pb-28 sm:pb-32 gap-4 sm:gap-6 lg:gap-12">
          ...
          <div className="text-center lg:text-left flex-1 max-w-2xl mx-auto lg:mx-0">
            <span className="inline-block px-6 py-2 bg-blue-500/40 rounded-full text-blue-100 font-medium mb-3 backdrop-blur-md animate-fadeIn border border-blue-400/30 shadow-lg">
            ...
            <h1 className="text-3xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold text-white mb-3 leading-tight drop-shadow-2xl">
              ...
              />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-purple-300 drop-shadow-lg">
                <Typewriter 
            ...
            <p className="text-lg lg:text-xl text-gray-200 mb-6 leading-relaxed max-w-xl lg:max-w-none mx-auto lg:mx-0 drop-shadow-lg font-medium opacity-0 animate-fadeIn" style={{ animationDelay: '3s', animationFillMode: 'forwards' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 lg:justify-start justify-center items-center lg:items-start opacity-0 animate-fadeIn" style={{ animationDelay: '3.5s', animationFillMode: 'forwards' }}>
              ...
              <a 
                href="#workflow" 
                className="w-full sm:w-auto bg-white/15 backdrop-blur-md text-white hover:bg-white/25 px-10 py-5 rounded-xl font-semibold text-center transition-all hover:-translate-y-2 border border-white/30 hover:border-white/50 shadow-lg text-lg"
              >
      ...
      <div className="absolute bottom-6 w-full flex justify-center z-20 pointer-events-none">
        <div className="flex flex-col items-center animate-bounce">
          <div className="w-1 h-10 bg-gradient-to-b from-blue-300 to-transparent rounded-full mb-2 shadow-lg shadow-blue-400/40"></div>
